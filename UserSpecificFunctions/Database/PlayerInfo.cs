...
namespace UserSpecificFunctions.Database
{
    ...
    public sealed class PlayerInfo
    {
       ...
       // [NotNull]
        ...
        public PlayerInfo(int userId, ChatData chatData)  // byDii [NotNull] ChatData chatData
        {
            UserId = userId;
        ...
        public PlayerInfo(int userId, ChatData chatData, PermissionCollection permissions) : this(userId, chatData)  // byDii [NotNull] ChatData chatData PermissionCollection
        {
